...
from rl_coach.graph_managers.vv_rl_graph_manager import VVRLGraphManager
from rl_coach.environments.ContMOT_wGradient_environment import ContMOTEnvironmentParameters
...
schedule_params.heatup_steps = EnvironmentSteps(15000)
schedule_params.improve_steps = TrainingSteps(975000)
...
env_params.det_meas = 0
env_params.grad_meas = 0
...
graph_manager = VVRLGraphManager(agent_params=agent_params, env_params=env_params,
