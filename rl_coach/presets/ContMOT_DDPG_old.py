...
schedule_params.heatup_steps = EnvironmentEpisodes(1000) #EnvironmentSteps(25000) #25000
schedule_params.improve_steps = EnvironmentEpisodes(80000) #TrainingSteps(2000000) #1500000
...
#agent_params = DDPGAgentParameters(use_batchnorm=True)
...
if observ == 1:
    ...
    agent_params.network_wrappers['actor'].input_embedders_parameters =  {'observation': InputEmbedderParameters()} 
    agent_params.network_wrappers['critic'].input_embedders_parameters =  {'observation': InputEmbedderParameters(),'action': InputEmbedderParameters(scheme=EmbedderScheme.Shallow)} 
